                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card mb-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('blog.post.read',$post->id) }}">Read more →</a>
                                </div>
                            </div>
                            <br>
                            @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <ul class="list-unstyled mb-0">
                                        @foreach ($books1 as $category)
                                        <li><a href="#!" class="btn btn-dark">{{$category}}</a></li>
                                        @endforeach
